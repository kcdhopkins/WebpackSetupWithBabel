...
module.exports = {
  ...
  module: {
    rules: [
      ...
      }, //allows for import of css files to be bundled...npm install css-loader style-loader --save-dev
      {
        test: /\.html$/,
      ...
      }, // add Babel and its preset npm command ...npm install babel-loader @babel/core @babel/preset-env --save-dev
  ...
  plugins: [
    new HtmlWebpackPlugin({
      ...
      title: "Webpack Setup"
    }), //points to manually created index.html in ./src
  ...
  mode: "development" // development or none
};
